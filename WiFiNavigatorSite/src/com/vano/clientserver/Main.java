...
public class Main implements Runnable{
	...
	/*
	 * подготавливаем класс дл€ передачи по сети
	 */
	...
	/*
	 * ѕосылаем сериализованный класс NavigationData клиенту
	 * или
	 * «аписываем в Ѕƒ пришедшие данные
	 */
	...
	/*
	 * Ќаходим соответствующее изображение на сервере
	...
	private static byte[] getImageInBytes(String imageName) throws IOException, ClassNotFoundException, SQLException{
		 ...
		 * а брать его из Ѕƒ, где оно будет хранитьс€ в виде
		 * массива байтов
		 */
	...
	/*
	 * —охран€ем данные (таблицу соответствий уровней сигналов координатам 
